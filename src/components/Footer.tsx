                ...
                <div className="pt-2 border-t border-slate-800 space-y-2">
                  ...
                  <div className="flex items-center gap-2.5">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-[#1877F2] hover:bg-[#0d65d9] text-white transition-all flex items-center justify-center shadow-md shadow-[#1877F2]/25 hover:scale-105"
                      title="Facebook Page"
                      aria-label="Facebook"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-gradient-to-tr from-[#833ab4] via-[#fd1d1d] to-[#fcb045] hover:opacity-90 text-white transition-all flex items-center justify-center shadow-md shadow-pink-600/25 hover:scale-105"
                    ...
                    <a
                      href="https://www.youtube.com/@lfsbrj"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-[#FF0000] hover:bg-[#cc0000] text-white transition-all flex items-center justify-center shadow-md shadow-[#FF0000]/25 hover:scale-105"
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-[#25D366] hover:bg-[#20bd5a] text-white transition-all flex items-center justify-center shadow-md shadow-[#25D366]/25 hover:scale-105"
                      title="WhatsApp"
                      aria-label="WhatsApp"
                    >
                      <svg className="w-4 h-4 sm:w-4.5 sm:h-4.5 fill-current" viewBox="0 0 24 24">
