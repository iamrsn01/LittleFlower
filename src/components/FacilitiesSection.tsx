...
export const FacilitiesSection: React.FC = () => {
  ...
  return (
    <section id="facilities" className="py-24 bg-slate-900 text-white relative overflow-hidden border-t border-slate-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
          <div className="space-y-4 max-w-2xl">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-red-500/10 border border-red-500/30 text-red-400 text-xs font-bold uppercase tracking-wider">
          ...
          <div className="flex items-center gap-3 self-start md:self-auto">
            ...
            <button
              onClick={handlePrev}
              className="w-12 h-12 bg-white/10 hover:bg-white/20 text-white backdrop-blur-md border border-white/20 transition-all flex items-center justify-center cursor-pointer hover:scale-105 active:scale-95 shadow-lg"
            ...
            <button
              onClick={handleNext}
              className="w-12 h-12 bg-red-600 hover:bg-red-500 text-white transition-all flex items-center justify-center cursor-pointer hover:scale-105 active:scale-95 shadow-lg shadow-red-600/30"
          ...
          {categories.map((cat) => {
            ...
            return (
              <button
                ...
                className={`px-4 py-2.5 text-xs font-bold transition-all duration-200 flex items-center gap-2 whitespace-nowrap cursor-pointer ${
                  isActive
        ...
        {/* Main Panoramic Slider Stage (Sharp Box) */}
        <div className="relative overflow-hidden border border-white/15 bg-slate-950 shadow-2xl">
          ...
          <AnimatePresence initial={false} custom={direction} mode="wait">
            <motion.div
              ...
              animate="center"
              exit="exit"
              className="relative min-h-[480px] lg:min-h-[580px] w-full flex flex-col justify-between p-6 sm:p-10 overflow-hidden"
            >
              ...
              <div className="relative z-10 flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <span className="px-3.5 py-1.5 text-xs font-bold backdrop-blur-md bg-white/20 text-white border border-white/30 shadow-md flex items-center gap-1.5">
                ...
                <div className="flex items-center gap-2">
                  <div className="px-3 py-1.5 backdrop-blur-md bg-black/60 text-white text-xs font-bold border border-white/20 flex items-center gap-1.5 font-mono">
                    <Users className="w-3.5 h-3.5 text-red-400" />
                    <span>{currentItem.capacity}</span>
                  </div>

                  <span className="px-2.5 py-1.5 bg-red-600 text-white text-xs font-mono font-bold">
              ...
              <div className="relative z-10 space-y-6 max-w-3xl mt-24 sm:mt-32">
                
                <div className="space-y-3">
                  <h3 className="text-2xl sm:text-4xl lg:text-5xl font-black text-white leading-tight font-display tracking-tight drop-shadow-md">
                    {currentItem.name}
                  </h3>

                  <p className="text-sm sm:text-base text-slate-300 leading-relaxed font-medium drop-shadow-sm max-w-2xl">
                    {currentItem.description}
                  </p>
                </div>

                {/* Highlights & Equipment Pills (Sharp boxes) */}
                <div className="space-y-3">
                ...
                <div className="pt-2 flex flex-wrap items-center gap-3">
                  <button
                    ...
                    className="px-6 py-3.5 text-xs sm:text-sm font-bold bg-white hover:bg-slate-100 text-slate-900 transition-all flex items-center gap-2 cursor-pointer shadow-lg hover:scale-105 active:scale-95"
                  >
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      onClick={handlePrev}
                      className="p-3.5 bg-white/10 hover:bg-white/20 text-white backdrop-blur-md border border-white/20 transition-all cursor-pointer"
                      title="Previous"
                    >
            ...
            {filteredFacilities.map((fac, idx) => {
              ...
              return (
                <button
                  ...
                  className={`relative shrink-0 w-36 sm:w-44 aspect-[16/10] overflow-hidden border-2 transition-all duration-300 text-left group cursor-pointer ${
                    isActive
